(function () {
  ...
  var strings = {
    en: {
      ...
      "expertise.title": "Korean clinical experience, delivered inclusively",
      "expertise.body": "Korean expertise is the centre of authority: professional cosmetic experience in South Korea, extensive injectable history, and clinical knowledge of Asian skin. Care is offered to Korean, Chinese, other Asian and Caucasian women who appreciate Korean aesthetics and culture.",
      "value.safety.title": "Safety",
      "value.safety.body": "Clinical responsibility comes before sales or trends.",
      "value.pro.title": "Professionalism",
      "value.pro.body": "Every interaction should feel prepared, precise and credible.",
      "value.korea.title": "Korean expertise",
      "value.korea.body": "A meaningful clinical advantage, not a decorative theme.",
      "value.results.title": "Results",
      "value.results.body": "Realistic outcomes, with a clear path to improvement.",
    ...
    zh: {
      ...
      "expertise.title": "韩国临床经验，面向多元求美者",
      "expertise.body": "韩国专业是权威核心：韩国美容临床经验、丰富注射经历，以及对亚洲皮肤的临床认知。服务对象包括韩裔、华裔、其他亚裔及欣赏韩式美学与文化的白人女性。",
      "value.safety.title": "安全",
      "value.safety.body": "临床责任优先于销售或潮流。",
      "value.pro.title": "专业",
      "value.pro.body": "每一次沟通都应准备充分、准确、可信。",
      "value.korea.title": "韩国专业",
      "value.korea.body": "实质性的临床优势，而不是装饰性主题。",
      "value.results.title": "效果",
      "value.results.body": "务实结果，并有清晰的改善路径。",
      "process.kicker": "诊疗路径",
    ...
    ko: {
      ...
      "expertise.title": "한국의 임상 경험, 포용적으로",
      "expertise.body": "한국 전문성은 권위의 중심입니다. 한국의 전문 미용 임상, 풍부한 주사 이력, 아시아 피부에 대한 임상 지식. 한국, 중국, 그 외 아시아, 그리고 한국 미학과 문화를 중시하는 백인 여성을 진료합니다.",
      "value.safety.title": "안전",
      "value.safety.body": "임상 책임이 판매나 유행보다 앞섭니다.",
      "value.pro.title": "전문성",
      "value.pro.body": "모든 만남이 준비되고 정확하며 신뢰감 있어야 합니다.",
      "value.korea.title": "한국 전문성",
      "value.korea.body": "장식이 아닌, 실질적인 임상 이점입니다.",
      "value.results.title": "결과",
      "value.results.body": "현실적인 결과, 그리고 분명한 개선 경로.",
